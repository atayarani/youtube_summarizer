...
class TestTakeaways:
    ...
    def test_raises_value_error_when_messages_is_none(self, mocker):
        ...
        ai = AI(MockTranscript("This is a transcript", MockMetadata(
            title="Test title",
    ...
    def test_handles_edge_cases_when_transcript_is_too_long(self, mocker):
        ...
        class MockChatOpenAI:
            ...
            def stream(self, messages):
                return [SystemMessage(content="Key takeaway 1"), SystemMessage(content="Key takeaway 2")]

        mocker.patch("src.ai.ChatOpenAI", MockChatOpenAI)

        # Create an instance of the AI class
        ai = AI(MockTranscript("This is a very long transcript" * 1000, MockMetadata(
            title="Test title",
            publish_date="2021-01-01",
            author="Test author",
            url="https://www.youtube.com/watch?v=dQw4w9WgXcQ")))
